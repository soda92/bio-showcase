...
export function Header() {
  return (
    <header class="h-[110px] sm:!h-[144px] w-full bg-cover bg-no-repeat relative" // You could even add a background image here if desired
      // style={{ backgroundImage: 'url(/path-to-header-bg.jpg)', backgroundSize: 'cover' }}
    >
      <div class="rainfall w-full h-full absolute" />{" "}
      {/* Assuming 'rainfall' is a visual effect */}
      <nav class="w-11/12 h-24 max-w-5xl mx-auto flex items-center justify-start relative px-4 sm:px-6">
        {/* Added px-4 sm:px-6 */}
        <a href="/" class="flex items-center space-x-3">
          {/* Use flex to align logo and title */}
          <img
            src="/favicon.ico"
            alt="Site Logo"
